...
class BarcodeScannerViewController: UIViewController {
    ...
    private lazy var xCor: CGFloat! = {
        return (screenSize.width - (screenSize.width*0.65))/2
    }()
    private lazy var yCor: CGFloat! = {    
        return (screenSize.height - (screenSize.width*0.65))/2
    }()
    //Bottom view
    ...
    override public func viewDidLoad() {
        ...
        let screenHeight = (SwiftFlutterBarcodeScannerPlugin.scanMode == ScanMode.QR.index) ? (screenSize.width*0.65) : (screenSize.width * 0.5)
        do {
            ...
            captureMetadataOutput.rectOfInterest = CGRect(x: xCor, y: yCor, width: (screenSize.width*0.65), height: screenHeight)
        ...
        let transparentPath = UIBezierPath(rect: CGRect(x: xCor, y: yCor, width: (screenSize.width*0.65), height: screenHeight))
        ...
        let scanRect = CGRect(x: xCor, y: yCor, width: (screenSize.width*0.65), height: screenHeight)
    ...
    private func drawLine() {
        ...
        scanlineRect = CGRect(x: xCor, y: yCor, width:(screenSize.width*0.65), height: 2)
        scanlineStartY = yCor
        scanlineStopY = (SwiftFlutterBarcodeScannerPlugin.scanMode == ScanMode.QR.index ? (yCor + (screenSize.width*0.65)) : (yCor + screenSize.width * 0.5))
        
        //  return (SwiftFlutterBarcodeScannerPlugin.scanMode == ScanMode.QR.index) ? (screenSize.height) : (screenSize.height / 2)
        //        scanlineStopY = yCor + (screenSize.width*0.65)
    }
