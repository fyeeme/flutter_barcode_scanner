...
class BarcodeScannerViewController: UIViewController {
    ...
    private lazy var xCor: CGFloat! = {
        return self.isOrientationPortrait ? (screenSize.width - (screenSize.width*0.65))/2 :
            (screenSize.height)/2
    }()
    private lazy var yCor: CGFloat! = {    
        return self.isOrientationPortrait ? (screenSize.height - (screenSize.width*0.65))/2 :
            (screenSize.height - (screenSize.height*0.65))/2
    }()
    //Bottom view
    ...
    override public func viewDidLoad() {
        ...
        if isOrientationPortrait {
            screenHeight = (CGFloat)((SwiftFlutterBarcodeScannerPlugin.scanMode == ScanMode.QR.index) ? (screenSize.width * 0.65) : (screenSize.width * 0.5))
        ...
        do {
            ...
            let captureRectWidth = self.isOrientationPortrait ? (screenSize.width*0.65):(screenSize.height*0.65)
        ...
        let transparentPath = UIBezierPath(rect: CGRect(x: xCor, y: yCor, width: self.isOrientationPortrait ? (screenSize.width*0.65) : (screenSize.height*0.65), height: screenHeight))
        ...
        let scanRect = CGRect(x: xCor, y: yCor, width: self.isOrientationPortrait ? (screenSize.width*0.65) : (screenSize.height*0.65), height: screenHeight)
        ...
        qrCodeFrameView!.frame = CGRect(x: 0, y: 0, width: self.isOrientationPortrait ? (screenSize.width * 0.65) : (screenSize.height * 0.65), height: screenHeight)
    ...
    private func drawLine() {
        ...
        scanlineRect = CGRect(x: xCor, y: yCor, width:self.isOrientationPortrait ? (screenSize.width*0.65) : (screenSize.height*0.65), height: 2)
        scanlineStartY = yCor
        
        var stopY:CGFloat
        
        if SwiftFlutterBarcodeScannerPlugin.scanMode == ScanMode.QR.index {
            let w = self.isOrientationPortrait ? (screenSize.width*0.65) : (screenSize.height*0.6)
            stopY = (yCor + w)
        } else {
